...
def run_gss_stage(truth_data_15ch, clean_truth_15ch, base_state, base_params, metapop_handle):
    struct = build_gss_theta_structure(ESTIMATION_CONFIG, base_state, base_params)
    grid_results = []
